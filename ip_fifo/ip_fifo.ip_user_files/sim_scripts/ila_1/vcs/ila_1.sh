...
#
# Generated by Vivado on Thu Jun 20 17:23:00 +0800 2024
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../ip_fifo.srcs/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../ip_fifo.srcs/sources_1/ip/ila_1/hdl/verilog" \
    "$ref_dir/../../../../ip_fifo.srcs/sources_1/ip/ila_1/sim/ila_1.v" \
  2>&1 | tee -a vlogan.log
